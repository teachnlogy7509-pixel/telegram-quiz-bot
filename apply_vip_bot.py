...
premium_handlers='''    app.add_handler(CommandHandler("hub", lambda u,c: premium_hub.cmd_hub(u,c,db,leaderboard)))
...
if 'CommandHandler("hub"' not in s:
 line='    app.add_handler(CommandHandler("aistatus", multi_provider.cmd_aistatus))'
